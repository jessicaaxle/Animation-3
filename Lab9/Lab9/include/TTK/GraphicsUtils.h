...
namespace TTK
{
	...
	public:
		...
		// This needs to be called at the start of each frame
		static void TTK::Graphics::StartUI(int windowWidth, int windowHeight);

		// This needs to be called once you are done drawing UI stuff
		static void EndUI();
