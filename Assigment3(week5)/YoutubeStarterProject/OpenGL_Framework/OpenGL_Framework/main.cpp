...
{
	//****Make sure to not call OpenGL things before the window is created****
	/* initialize the window and OpenGL properly */
	glutInit(&argc, argv);
	glutInitContextVersion(4, 2); //Access the version of OpenGL, if not specified it will choose the version on its own
